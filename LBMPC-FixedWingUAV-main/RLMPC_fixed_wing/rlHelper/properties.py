...
# velocities
u_fps = BoundedProperty('velocities/u-fps', 'body frame x-axis velocity [ft/s]', 0, 45)
v_fps = BoundedProperty('velocities/v-fps', 'body frame y-axis velocity [ft/s]', -2200, 2200)
w_fps = BoundedProperty('velocities/w-fps', 'body frame z-axis velocity [ft/s]', 0, 45)
...
q_radps = BoundedProperty('velocities/q-rad_sec', 'pitch rate [rad/s]', -0.5*math.pi, 0.5*math.pi)
...
elevator = BoundedProperty('fcs/elevator-pos-norm', 'elevator position, normalised', 0, 60 * math.pi / 180)
...
# weights weights work as an action here
Q0 = BoundedProperty('fcs/rudder-cmd-norm', 'rudder commanded position, normalised', 0.3, 10.)
Q1 = BoundedProperty('fcs/throttle-cmd-norm', 'throttle commanded position, normalised', 0.3, 10.)
Q2 = BoundedProperty('fcs/mixture-cmd-norm', 'engine mixture setting, normalised', 0.3, 10.)
Q3 = BoundedProperty('fcs/throttle-cmd-norm[1]', 'throttle 1 commanded position, normalised', 0.3, 10.)
Q4 = BoundedProperty('fcs/throttle-cmd-norm[1]', 'throttle 1 commanded position, normalised', 0.3, 10.)
R1 = BoundedProperty('fcs/mixture-cmd-norm[1]', 'engine mixture 1 setting, normalised', 0.3, 10.)
R2 = BoundedProperty('gear/gear-cmd-norm', 'all landing gear commanded position, normalised', 0.3, 10.)